...
class ServiceBase(BaseModel):
    ...
    price: Decimal = Field(..., description="价格", gt=0, max_digits=10, decimal_places=2)
...
class ServiceUpdate(BaseModel):
    ...
    description: Optional[str] = Field(None, description="描述", max_length=500)
    price: Optional[Decimal] = Field(None, description="价格", gt=0, max_digits=10, decimal_places=2)
